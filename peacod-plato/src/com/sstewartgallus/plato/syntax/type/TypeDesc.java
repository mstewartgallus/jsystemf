...
public class TypeDesc<A> extends DynamicConstantDesc<Type<A>> {
    ...
    private static final ClassDesc CD_Type = ClassDesc.of(TYPE_PACKAGE, "Type");
    private static final ClassDesc CD_NominalType = ClassDesc.of(TYPE_PACKAGE, "NominalType");
    private static final ClassDesc CD_TypeTag = ClassDesc.of(TYPE_PACKAGE, "TypeTag");
    // fixme... move these out ?
    private static final ClassDesc CD_FunctionTag = ClassDesc.of(TYPE_PACKAGE, "FunctionTag");
    private static final ClassDesc CD_JavaTag = ClassDesc.of("com.sstewartgallus.plato.java", "JavaTag");
