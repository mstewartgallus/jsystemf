...
public abstract class Closure<A, B> implements Function<A, B> {
    ...
    public static MethodHandle spinFactory(MethodType methodType) {
...

        {
            ...
            mw.visitMethodInsn(Opcodes.INVOKESTATIC, Type.getInternalName(Closure.class), "register", methodType(void.class, MethodHandles.Lookup.class).descriptorString(), false);
