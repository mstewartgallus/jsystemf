...
import com.sstewartgallus.interpreter.ReferenceInterpreter;
...
public final class ApplyLinker implements TypeBasedGuardingDynamicLinker {
    ...
    static {
        try {
            STEP_THUNK_MH = lookup().findVirtual(ApplyTerm.class, "step", methodType(ReferenceInterpreter.class, ReferenceInterpreter.class));
